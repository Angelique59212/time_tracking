...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".reset, * {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n}\n\n.generic-header, header, .containerTask .divTask {\n  display: flex;\n  justify-content: space-around;\n  margin: 1rem;\n  padding: 1rem;\n}\n\nhtml {\n  font-size: 62.5%;\n}\n\nbody {\n  background-color: #d2d0ce;\n}\n\nheader h1 {\n  font-size: 3.5rem;\n  color: #831de1;\n}\nheader .buttonCreateProject {\n  padding: 0.5rem;\n  font-weight: bold;\n  font-size: 2rem;\n}\n\n.containerProject {\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: space-around;\n}\n.containerProject .divProject {\n  width: 39vw;\n  height: 56vh;\n  margin: 2rem;\n  border: 8px double #8c8c91;\n  border-radius: 0.4rem;\n}\n.containerProject .inputTitle {\n  padding: 0.5rem;\n  margin: 0.8rem;\n}\n.containerProject .title {\n  padding: 2.2rem;\n  text-align: center;\n  text-transform: uppercase;\n}\n\n.buttonValidate {\n  font-weight: bold;\n  font-size: 2rem;\n  padding: 0.2rem;\n}\n\n.divItems {\n  display: flex;\n  flex-direction: column;\n  width: 5vw;\n  height: 9vh;\n}\n.divItems .fa-clock, .divItems .fa-trash-can, .divItems .fa-eye, .divItems .fa-calendar-days {\n  color: #517573;\n  font-size: 4rem;\n  padding: 3rem;\n}\n.divItems .divBottom {\n  width: 36vw;\n  margin-top: 12rem;\n  display: flex;\n  justify-content: space-between;\n}\n.divItems .fa-trash-can, .divItems .fa-eye {\n  color: #544b4b;\n  font-size: 3rem;\n}\n.divItems .fa-eye {\n  font-size: 3rem;\n}\n.divItems .addTask {\n  background-color: #d2d0ce;\n  height: 3vh;\n  margin-top: 3rem;\n}\n\n.textTime {\n  text-align: center;\n}\n\n.containerTask {\n  width: 30vw;\n  height: 37vh;\n  border: 1px solid #575151;\n  margin-left: 13rem;\n  margin-top: -10rem;\n  background-color: #e8e6e3;\n}\n.containerTask .inputTask {\n  display: block;\n}\n.containerTask .divTask {\n  font-size: 2rem;\n  justify-content: space-around;\n  padding: 0.5rem;\n}\n.containerTask .divTask .fa-stopwatch {\n  color: #517573;\n}\n.containerTask .divTask .validTask {\n  padding: 0.5rem;\n}", "",{"version":3,"sources":["webpack://./assets/styles/modules/_vars.scss","webpack://./assets/styles/style.scss"],"names":[],"mappings":"AAAA;EACE,SAAA;EACA,UAAA;EACA,sBAAA;ACCF;;ADEA;EACE,aAAA;EACA,6BAAA;EACA,YAAA;EACA,aAAA;ACCF;;AALA;EACE,gBAAA;AAQF;;AALA;EACE,yBAAA;AAQF;;AAHE;EACE,iBAAA;EACA,cAAA;AAMJ;AAHE;EACE,eDTO;ECUP,iBDRU;ECSV,eDRQ;ACaZ;;AADA;EACE,aAAA;EACA,eAAA;EACA,6BAAA;AAIF;AAFE;EACE,WAAA;EACA,YAAA;EACA,YAAA;EACA,0BAAA;EACA,qBAAA;AAIJ;AADE;EACE,eD7BO;EC8BP,cD7BM;ACgCV;AAAE;EACE,eAAA;EACA,kBAAA;EACA,yBAAA;AAEJ;;AAEA;EACE,iBDvCY;ECwCZ,eDvCU;ECwCV,eAAA;AACF;;AAEA;EACE,aAAA;EACA,sBAAA;EACA,UAAA;EACA,WAAA;AACF;AACE;EACE,cDhDI;ECiDJ,eAAA;EACA,aAAA;AACJ;AACE;EACE,WAAA;EACA,iBAAA;EACA,aAAA;EACA,8BAAA;AACJ;AAEE;EAEE,cAAA;EACA,eAAA;AADJ;AAIE;EACE,eAAA;AAFJ;AAKE;EACE,yBAAA;EACA,WAAA;EACA,gBAAA;AAHJ;;AAQA;EACE,kBAAA;AALF;;AAQA;EACE,WAAA;EACA,YAAA;EACA,yBAAA;EACA,kBAAA;EACA,kBAAA;EACA,yBAAA;AALF;AAOE;EACE,cAAA;AALJ;AAQE;EACE,eAAA;EAEA,6BAAA;EACA,eAAA;AAPJ;AASI;EACE,cDpGE;AC6FR;AAUI;EACE,eD7GK;ACqGX","sourcesContent":[".reset {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n}\n\n.generic-header {\n  display: flex;\n  justify-content: space-around;\n  margin: 1rem;\n  padding: 1rem;\n}\n\n$padding : 0.5rem;\n$margin : 0.8rem;\n$font-weight: bold;\n$font-size: 2rem;\n$border : 1;\n$color: #517573;","@use \"./modules/vars\";\n\n* {\n  @extend .reset;\n}\n\nhtml {\n  font-size: 62.5%;\n}\n\nbody {\n  background-color: #d2d0ce;\n}\n\nheader {\n  @extend .generic-header;\n  h1 {\n    font-size: 3.5rem;\n    color: #831de1;\n  }\n\n  .buttonCreateProject  {\n    padding: vars.$padding;\n    font-weight: vars.$font-weight;\n    font-size: vars.$font-size;\n  }\n}\n\n.containerProject {\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: space-around;\n\n  .divProject {\n    width: 39vw;\n    height: 56vh;\n    margin: 2rem;\n    border: 8px double #8c8c91;\n    border-radius: 0.4rem;\n  }\n\n  .inputTitle {\n    padding: vars.$padding;\n    margin: vars.$margin;\n  }\n\n  .title {\n    padding: 2.2rem;\n    text-align: center;\n    text-transform: uppercase;\n  }\n}\n\n.buttonValidate {\n  font-weight: vars.$font-weight;\n  font-size: vars.$font-size;\n  padding: 0.2rem;\n}\n\n.divItems {\n  display: flex;\n  flex-direction: column;\n  width: 5vw;\n  height: 9vh;\n\n  .fa-clock , .fa-calendar-days {\n    color: vars.$color;\n    font-size: 4rem;\n    padding: 3rem;\n  }\n  .divBottom {\n    width: 36vw;\n    margin-top: 12rem;\n    display: flex;\n    justify-content: space-between;\n  }\n\n  .fa-trash-can, .fa-eye {\n    @extend .fa-clock;\n    color: #544b4b;\n    font-size: 3rem;\n  }\n\n  .fa-eye {\n    font-size: 3rem;\n  }\n\n  .addTask {\n    background-color: #d2d0ce;\n    height: 3vh;\n    margin-top: 3rem;\n  }\n}\n\n\n.textTime {\n  text-align: center;\n}\n\n.containerTask {\n  width: 30vw;\n  height: 37vh;\n  border: #{vars.$border}px solid #575151;\n  margin-left: 13rem;\n  margin-top: -10rem;\n  background-color: #e8e6e3;\n\n  .inputTask {\n    display: block;\n  }\n\n  .divTask {\n    font-size: 2rem;\n    @extend .generic-header;\n    justify-content: space-around;\n    padding: 0.5rem;\n\n    .fa-stopwatch {\n      color: vars.$color;\n    }\n\n    .validTask {\n      padding: vars.$padding;\n    }\n  }\n}\n\n\n"],"sourceRoot":""}]);
// Exports
...
let AddTask = function (containerTask, textTime, time, timeStop) {
    this.inputTask = function (projectContainer) {
        ...
        let validTask = document.createElement('button');
